...
void setup() {
  size(300, 200);
  // Asegúrate de que el puerto serial sea el correcto. Si hay más de un puerto, selecciona el adecuado.
  println(Serial.list()); // Imprime la lista de puertos seriales disponibles
  puerto = new Serial(this, Serial.list()[0], 9600); // Ajusta el índice según el puerto correcto
